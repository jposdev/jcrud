...
@Controller
@RequestMapping("/vet_specialties")
public class VetSpecialtyController extends TableController {

	public VetSpecialtyController(Table table, NamedParameterJdbcTemplate jdbcTemplate) {
